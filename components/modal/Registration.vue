            ...
            <div v-if="isUserSignedUp" class="level">
              <div class="level-item has-text-centered">
                <div>
                  ...
                  <p class="heading">Registrado exitosamente!</p>
                </div>
              </div>
            </div>
          </section>
...
export default {
  ...
  data () {
    return {
      ...
      primaryBtnLabel: 'Registro',
      btnRegisteredLabel: 'Cerrar',
      namePlaceholder: 'Nombre*',
      emailPlaceholder: 'Email*',
      passwordPlaceholder: 'Contraseña*',
      repeatPasswordPlaceholder: 'Repetir Contraseña*',
      notEqualErrorLabel: 'Las contraseñas deben coincidir',
      passwordErrorLabel: 'Contraseña requerida',
      nameErrorLabel: 'Nombre requerido',
      emailErrorLabel: 'Email requerido',
      emailNotValidLabel: 'Email valido requerido',
      name: '',
      email: '',
      password: '',
      repeatPassword: '',
